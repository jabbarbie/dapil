<!-- Modal -->
<div class="modal  modal-primary fade" id="formEditModal" tabindex="-1" role="dialog" aria-labelledby="formEditModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-group" method="post" action="caleg/upload_foto" id="formeditx"> 
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="id_dapil" id="combodapil">
              <?php foreach ($dapil as $key => $value): ?>
                <option value="<?php echo $value['dapil'] ?>"> <?php echo $value['dapil'] ?> </option>
              <?php endforeach ?>
            </select>
          </div>
          <div class="form-group">
            <label>Nama</label>
            <input type="text" class="form-control" id="xnama" name="nama" placeholder="Nama Lengkap"  autofocus="">
          </div>
          <div class="form-group">
