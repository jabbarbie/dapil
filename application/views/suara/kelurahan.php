...
<section class="content-header">
  ...
  <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-tv"></i><?php echo $kecamatan['kecamatan'] ?></a></li>
  </ol>
</section>
  ...
  <div class="col-sm-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">KECAMATAN - <?php echo $kecamatan['kecamatan'] ?></h3>
        </div>
        <div class="box-body">
              ...
              <tbody>
                ...
                <?php foreach ($kelurahan as $key => $value): ?>
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo base_url().'suara/kelurahan/'.$value['id_kelurahan'];?>">
